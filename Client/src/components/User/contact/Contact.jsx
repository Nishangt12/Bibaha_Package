...
const Contact = () => {
  return (
    ...
    <section className="text-gray-600 body-font relative">
      <div className="containers px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            marginWidth="0"
            scrolling="no"
            src="https://www.google.com/maps/place/P987%2B9J7,+Kathmandu+44600/@27.7160224,85.3643699,19.86z/data=!4m6!3m5!1s0x39eb1bd0358d0b61:0xb3210c8fba89d190!8m2!3d27.7159261!4d85.3640349!16s%2Fg%2F11k39q49fk?entry=ttu"
            style={{ filter: 'grayscale(1) contrast(1.2) opacity(0.4)' }}
          ></iframe>
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
              <p className="mt-1">Boudha, Kathmandu, Nepal</p>
            </div>
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
              <a href="mailto:Bibaha Package@email.com" className="text-orange-500 leading-relaxed">Bibaha Package@email.com</a>
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
              <p className="leading-relaxed">980000000</p>
            </div>
          </div>
        </div>
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h2>
          <p className="leading-relaxed mb-5 text-gray-600">Please provide your feed back</p>
